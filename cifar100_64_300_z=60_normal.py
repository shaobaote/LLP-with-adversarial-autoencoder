...
import networks,datasets,losses,utils,train_llp_aae,train_ss_aae,train_aae,train_dllp
...
def get_args():
    ...
    z_dim= 60#number of styles for the data
    img_size=32 if dataset_name in ['svhn','cifar10','cifar100'] else 28  #length of size for the image
    channels=3 if dataset_name in ['svhn','cifar10','cifar100'] else 1
