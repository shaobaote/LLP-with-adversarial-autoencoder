...
import networks,datasets,losses,utils,train_llp_aae,train_ss_aae,train_aae,train_dllp,train_llp_aae_gan_loss
...
def get_args():
    ...
    y_dim=10 #number of classes for the data
    z_dim= 2#number of styles for the data
    img_size=28  #length of size for the image
    channels=1
...
def main(args):
    if args.method=='dllp':
        ...
        train_llp_aae.train_start(args)
    elif args.method=='ss_aae':
        train_ss_aae.train_start(args)
    elif args.method=='aae':
        train_aae.train_start(args)
    elif args.method=='llp_aae_gan_loss':
        train_llp_aae_gan_loss.train_start(args)
    else:
