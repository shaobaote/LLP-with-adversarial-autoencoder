...
import networks,datasets,losses,utils,train_llp_aae_ent,train_ss_aae,train_aae,train_dllp
...
def get_args():
    ...
    parser.add_argument("--ent", default=ent, type=int)
...
def main(args):
    if args.method=='dllp':
        ...
        train_llp_aae_ent.train_start(args)
